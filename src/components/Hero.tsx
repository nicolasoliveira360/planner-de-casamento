    ...
    <section className="bg-gradient-to-b from-beige-50 to-beige-100 py-16 md:py-20 lg:py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative">
        ...
        <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-bold text-olive-800 mb-4 md:mb-6 leading-[1.2] tracking-tight">
          👰 Organize o casamento dos seus sonhos com 
          <span className="block text-olive-600 mt-2">facilidade e economia!</span>
        </h1>

        <p className="text-[16px] md:text-[17px] lg:text-[18px] text-olive-700 mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed">
        Nosso Planner Digital oferece checklists detalhados, controle de orçamento, lista de convidados e muito mais, 
        para que você tenha total controle do seu grande dia, economizando tempo e dinheiro.
        </p>
        ...
        <div className="aspect-video w-full max-w-4xl mx-auto mb-8 md:mb-12 rounded-2xl md:rounded-3xl overflow-hidden shadow-hover transition-all duration-300 hover:scale-[1.02]">
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/FoQqnQOanMY?autoplay=1&mute=1&controls=1&rel=0&modestbranding=1&showinfo=0&iv_load_policy=3&disablekb=1"
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <span className="relative z-10">👉 Garanta agora o seu Planner por apenas R$47</span>
